  ...
  const socialItems = [
    {
      ...
      color: 'text-gray-800', // Default color for Github
    },
    {
      name: 'Twitter',
            ...
            {menuItems.map((item) => (
              <Link
                ...
                className={`flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                  isActivePath(item.path) ? 'bg-gray-50' : 'hover:bg-gray-50'
                } group`}
              >
          ...
          <div className="flex space-x-4">
            ...
            {socialItems.map((item) => (
              <a
                ...
                className="flex items-center justify-center p-2 rounded-lg transition-colors hover:bg-gray-100 group"
              >
                <span className={`${item.color} group-hover:text-opacity-80`}>
                  {item.icon}
                </span>
